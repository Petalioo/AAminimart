...
const CartProduct = () => {
    ...
    return (
        <div className="flex flex-col md:flex-row mt-16">
            {/* Show loading state or debug info if needed */}
            {products.length === 0 && (
            ...
            {products.length > 0 && Object.keys(cartItems).length === 0 && (
                <div className="text-center p-8">
                    ...
                    <button onClick={()=>{navigate('/products'); scrollTo(0,0)}} className="mt-4 px-6 py-2 bg-indigo-500 text-white rounded hover:bg-indigo-600">
                        Start Shopping
                    </button>
                </div>
            )}
                        ...
                        <div className="text-gray-500 mt-4 space-y-2">
                            ...
                            <p className="flex justify-between">
                                <span>Tax (2%)</span><span>
                                    {currency}{Math.round(getCartAmount() * 0.02 / 100)}</span>
                            </p>
                            <p className="flex justify-between text-lg font-medium mt-3">
                                <span>Total Amount:</span><span>
                                    {currency}{getCartAmount() + getCartAmount() * 0.02 / 100}</span>
                            </p>
                        </div>
