        ...
        <div className="mt-12">
           ...
           <div className="flex flex-col items-center mt-20">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 md:gap-6 lg:grid-cols-5 mt-6 w-full">
                 ...
                 <button onClick={() => {navigate('/products'); window.scrollTo(0,0)}} className="mx-auto cursor-pointer px-12 my-16 py-2.5 border rounded text-red-500 hover:bg-red-50 transition">
                   See more
                 </button>
            </div> 
